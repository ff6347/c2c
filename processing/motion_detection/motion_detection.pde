...
// Additions by Fabian Morón Zirfas
// use on the Arduino side the sketch
// c2c_incoming.ino
// https://github.com/fabiantheblind/c2c/blob/master/arduino/c2c_incoming/c2c_incoming.ino
...
void draw() {
  ...
  /**
   * Now we use Daniels Motion Detection to send some values over to the board
   */
